...
const Izmeni = ({ cars }) => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            await axios.put(`http://127.0.0.1:8000/api/cars/${id}`, updatedCarData, {
                headers: {
        ...
        <div>
            ...
            <form onSubmit={handleSubmit}>
                ...
                <div>
                    ...
                    <input type="number" name="price_per_day" value={carData.price_per_day} onChange={handleChange} required />
                </div>
                <div>
